...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, accountTestUsageRepository, openAIGatewayService, settingService, pluginManager)
	...
	personalImageDeploymentService := service.ProvidePersonalImageDeploymentService(configConfig)
	...
	systemHandler := handler.ProvideSystemHandler(updateService, personalImageDeploymentService, systemOperationLockService)
	adminSubscriptionHandler := admin.NewSubscriptionHandler(subscriptionService)
	usageCleanupRepository := repository.NewUsageCleanupRepository(client, db)
	usageCleanupService := service.ProvideUsageCleanupService(usageCleanupRepository, timingWheelService, dashboardAggregationService, configConfig)
	adminUsageHandler := admin.NewUsageHandlerWithAccountTestUsage(usageService, apiKeyService, adminService, usageCleanupService, accountTestUsageRepository)
