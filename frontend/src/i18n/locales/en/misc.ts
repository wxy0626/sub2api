export default {
  ...
  version: {
    ...
    rollbackSelectImage: 'Select a personal published image to roll back to',
    rollbackConfirm: 'Roll back to my version {image}',
    rollbackWarning:
      'Rollback downloads the selected version and replaces the current binary. A service restart is required afterwards.',
    rollbackPersonalImageWarning:
      'Only the Sub2API application container is replaced. PostgreSQL, Redis, data volumes, account configuration, and the source workspace are preserved.',
    rollbackReconnecting: 'Replacing the personal Git image and waiting for the service to recover',
    rollbackAutoRestarting: 'Personal image deployment is in progress. The page will refresh automatically in about {seconds}s.',
    personalVersions: 'My Deployable Versions',
    personalVersionSource: 'Each version is verified against its Git tag, commit, image digest, and OCI revision.',
    deployPersonalLatest: 'Deploy My Latest Version {version}',
    deployingPersonalLatest: 'Deploying my latest version...',
    deployPersonalLatestFailed: 'Failed to deploy my latest personal image version',
    personalRollbackVersions: 'Roll Back To My History',
    upstreamUpdateAvailable: 'Upstream v{version} is available (view only)',
    ...
    copyCommand: 'Copy',
    copied: 'Copied',
    noRollbackVersions: 'No verified personal published image versions are available',
    loadVersionsFailed: 'Failed to load my Git and image version list',
    deployScript: 'Script',
    deployDocker: 'Docker',
