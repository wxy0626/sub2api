export default {
    scheduledTests: {
      ...
      running: 'Running',
      schedule: 'Schedule',
      cronHelp: 'Standard 5-field cron expression (default: 0 * * * *, every 60 minutes)',
      ...
      cronTooltipExampleEvery60Min: '0 * * * *: run every 60 minutes',
      ...
      cronTooltipRange: 'Recommended range: use standard 5-field cron. For health checks, start with every 60 minutes or once a day instead of running too often.',
