export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        sourceExternal: 'Third-party API',
        sourceAccount: 'Existing account',
        account: 'Account',
        accountPlaceholder: 'Select an account to monitor',
        accountHint: 'Tests run with the account credentials saved on the server; your local API key is never sent upstream.',
        accountRequired: 'Select an account to monitor',
        linkedAccount: 'Linked account',
        linkedAccountPlaceholder: 'Select a linked account',
        linkedAccountHint: 'Use the saved credentials for monitoring.',
        linkedAccountMissing: 'The linked account does not exist or was deleted.',
        linkedAccountEmpty: 'No accounts are available to link.',
        ...
        checkModeProbe: 'Active probe',
        checkModeProbeHint: 'Send scheduled requests upstream to check channel availability.',
        checkModeQuota: 'Quota mode',
        checkModeQuotaHint: 'Query the linked account balance or quota without sending a full model request.',
        checkModeQuotaProbe: 'Quota active probe',
        checkModeQuotaProbeHint: 'Actively check the remaining account quota through the quota endpoint.',
        endpoint: 'Endpoint',
        endpointPlaceholder: 'https://api.example.com',
        useCurrentDomain: 'Use current service',
        endpointHTTPSHint: 'Only HTTPS origin URLs are supported, such as https://api.example.com.',
        endpointHTTPSRequired: 'The endpoint must be an HTTPS origin URL, such as https://api.example.com.',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'Enter API Key',
