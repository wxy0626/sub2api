export default {
    accounts: {
      ...
      proxyUpdated: 'Account proxy updated',
      proxyUpdateFailed: 'Failed to update the account proxy. Check that the proxy is available and try again.',
      priorityUpdated: 'Account priority level updated',
      ...
      openai: {
        ...
        compactResponsesUnsupported: 'Responses unsupported',
      ...
      syncLatestModelsLoading: 'Syncing latest models...',
      syncLatestModelsSuccess: 'Synced {count} latest supported model(s)',
      syncLatestModelsFailed: 'Failed to sync latest supported models',
      syncLatestModelsError: 'Failed to sync latest supported models: {message}',
      ...
      loadFactorFollowConcurrency: 'Defaults to concurrency capacity',
      priority: 'Priority',
      ...
      concurrencyCapacityUpdated: 'Concurrency capacity and load factor updated successfully',
      concurrencyCapacityUpdateFailed: 'Failed to update concurrency capacity. Enter positive integers for both values and try again.',
      concurrencyCapacityInvalid: 'Concurrency capacity must be a positive integer; load factor must be an integer from 1 to 10000.',
      ...
      oauth: {
        ...
        // Gemini specific
	        gemini: {
	          ...
	          generateAuthUrl: 'Generate Auth URL',
	          projectIdLabel: 'Project ID (only when auto-detection fails)',
	          projectIdPlaceholder: 'e.g. my-gcp-project or cloud-ai-companion-xxxxx',
	          projectIdHint:
	            'The system auto-detects this after code exchange. If Google does not return a project ID, enter a valid GCP Project ID you own here, then regenerate the authorization URL and authorize again.',
      ...
      gemini: {
        ...
        oauthType: {
          ...
          googleOneDesc: 'Personal account with Google One subscription quota; project ID is auto-detected first',
          ...
          badges: {
            ...
            projectFallback: 'Project ID if auto-detect fails',
      ...
      workspaceProbeStarted: 'Checking ChatGPT workspace status...',
      workspaceDeactivated: 'Workspace is deactivated (402 deactivated_workspace)',
      openaiConnectionEOF: 'Request failed: the connection to the ChatGPT upstream closed unexpectedly (EOF). Check the proxy and network, then retry.',
      upstreamConnectionFailed: 'Request failed: unable to connect to the upstream service. Check the proxy, network, and account configuration.',
      authenticationFailed: 'Authentication failed: re-authorize the account or check its credentials.',
      upstreamApiFailed: 'The upstream API returned an error. Review the error details for status, code, and upstream response.',
      upstreamRetrying: 'The upstream connection closed unexpectedly; retrying once.',
      testErrorDetailsInLogs: 'Account test failed. Review the detailed error reason and technical fields.',
      accountErrorDetailsInLogs: 'Account error. Review the detailed error reason and technical fields.',
      ...
      stats: {
        ...
        testUsage: 'Account Test Statistics',
        testUsageHint: 'Admin connection tests are recorded separately and never billed to users',
        testRequests: 'Test Requests',
        testSuccess: 'Success',
        testFailed: 'Failed',
        testTokens: 'Test Tokens',
        testAvgResponseTime: 'Avg Test Time',
        testRecords: 'Recent Test Records',
        testModel: 'Model',
        testEndpoint: 'Endpoint',
        testStatus: 'Result',
        testTime: 'Time',
        testError: 'Error Details',
        testSucceeded: 'Success',
        testFailedStatus: 'Failed',
        noTestData: 'No account test records in the last 30 days'
      },
      usageWindow: {
