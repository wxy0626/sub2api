export default {
    accounts: {
      ...
      upstreamApiFailed: 'The upstream API returned an error. Check the server logs for details.',
      upstreamRetrying: 'The upstream connection closed unexpectedly; retrying once.',
      testErrorDetailsInLogs: 'Account test failed. Check the server logs for details.',
      accountErrorDetailsInLogs: 'Account error. Check the server logs for details.',
