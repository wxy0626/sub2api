export default {
    accounts: {
      ...
      bulkActions: {
        ...
        refreshToken: '批量刷新令牌',
        test: '批量测试',
        testSelectionRequired: '请先勾选至少一个账号后再进行批量测试',
      ...
      openai: {
        ...
        compactResponsesUnsupported: '不支持 Responses',
      ...
      syncLatestModelsLoading: '同步最新模型中...',
      syncLatestModelsSuccess: '已同步 {count} 个最新支持模型',
      syncLatestModelsFailed: '同步最新支持模型失败',
      syncLatestModelsError: '同步最新支持模型失败：{message}',
      ...
      loadFactorFollowConcurrency: '默认跟随并发容量',
      priority: '优先级',
      ...
      concurrencyCapacityUpdated: '并发容量和负载因子更新成功',
      concurrencyCapacityUpdateFailed: '更新并发容量失败，请确认并发容量和负载因子为正整数后重试。',
      concurrencyCapacityInvalid: '并发容量必须是正整数，负载因子必须是 1 到 10000 的整数。',
      ...
      oauth: {
        ...
        gemini: {
          ...
          generateAuthUrl: '生成授权链接',
          projectIdLabel: 'Project ID（自动检测失败时填写）',
          projectIdPlaceholder: '例如：my-gcp-project 或 cloud-ai-companion-xxxxx',
          projectIdHint:
            '系统会在兑换授权码后自动探测。若 Google 未返回项目 ID，请在此填写您拥有的有效 GCP Project ID，再重新生成授权链接并授权。',
      ...
      gemini: {
        ...
        oauthType: {
          ...
          googleOneDesc: '个人账号，享受 Google One 订阅配额；项目 ID 会优先自动检测',
      ...
      workspaceProbeStarted: '正在检测 ChatGPT 工作区状态...',
      workspaceDeactivated: 'ChatGPT 工作区已停用（402）：该工作区已被停用',
      openaiConnectionEOF: '请求失败：与 ChatGPT 上游服务的连接意外中断（EOF），请检查代理和网络后重试。',
      upstreamConnectionFailed: '请求失败：无法连接到上游服务，请检查代理、网络和账号配置。',
      authenticationFailed: '身份验证失败：请重新授权或检查账号凭据。',
      upstreamApiFailed: '上游接口返回错误，请查看错误详情中的状态码、错误码和上游返回内容。',
      upstreamRetrying: '上游连接意外中断，正在自动重试一次。',
      testErrorDetailsInLogs: '账号测试失败，请查看错误详情中的具体原因和技术字段。',
      accountErrorDetailsInLogs: '账号异常，请查看错误详情中的具体原因和技术字段。',
