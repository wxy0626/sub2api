export default {
  ...
  version: {
    ...
    rollbackSelectImage: '选择要回退的个人发布镜像版本',
    rollbackConfirm: '回退到我的版本 {image}',
    rollbackWarning: '回退将拉取所选的个人镜像 digest 并替换当前程序',
    rollbackPersonalImageWarning: '仅替换 Sub2API 应用容器；PostgreSQL、Redis、数据卷、账号配置和源码工作区保持不变',
    rollbackReconnecting: '正在替换个人 Git 镜像并等待服务恢复',
    rollbackAutoRestarting: '个人镜像部署处理中，预计 {seconds} 秒后自动刷新页面',
    personalVersions: '我的可部署版本',
    personalVersionSource: '版本已校验 Git tag、commit、镜像 digest 和 OCI revision',
    deployPersonalLatest: '部署我的最新版本 {version}',
    deployingPersonalLatest: '正在部署我的最新版本...',
    deployPersonalLatestFailed: '部署我的最新个人镜像版本失败',
    personalRollbackVersions: '回退到我的历史版本',
    upstreamUpdateAvailable: '上游有新版本 v{version}（仅供查看）',
    rollingBack: '正在回退...',
    ...
    copyCommand: '复制',
    copied: '已复制',
    noRollbackVersions: '暂无已验证的个人发布镜像版本',
    loadVersionsFailed: '获取我的 Git 与镜像版本列表失败',
    deployScript: '脚本部署',
    deployDocker: 'Docker',
